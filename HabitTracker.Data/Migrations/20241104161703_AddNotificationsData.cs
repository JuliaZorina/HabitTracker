...
{
    /// <inheritdoc />
    public partial class AddNotificationsData : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HabitNotificationEntityId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HabitsNotificationSettings_HabitsNotificationSettings_Habit~",
                        column: x => x.HabitNotificationEntityId,
                        principalTable: "HabitsNotificationSettings",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HabitsNotificationSettings_HabitNotificationEntityId",
                table: "HabitsNotificationSettings",
                column: "HabitNotificationEntityId");
